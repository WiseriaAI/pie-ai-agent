...
export const jaDict = {
  ...
  skillGrant: {
    ...
    semanticsNote: "スクリプトはあなたのマシン上で実行されます。マシン上のどこからでもファイルを読み取ることができますが、skill の隔離された作業ディレクトリ内にのみ書き込むことができます。ネットワークアクセスはブロックされています。",
    skillLabel: "Skill",
    scriptLabel: "スクリプト",
    permsLabel: "要求されるアクセス権",
    permFs: "コンピューター上のどこからでもファイルを読み取る；skill の作業ディレクトリ内にのみ書き込む",
    allow: "許可",
    deny: "拒否",
  },
  chat: {
