...
export const zhCNDict = {
  ...
  chat: {
    ...
    files: { attachFile: "附加文件", truncated: "已截断", remove: "移除文件", fileAttachments: "文件附件", tooLarge: "{name} 超过 5MB 上限", unsupported: "{name}：不支持的文件类型", processingFailed: "无法读取该文件", requestTitle: "Pie 想读取一个本地文本或 PDF 文件", requestChoose: "选择文件", requestCancel: "取消" },
